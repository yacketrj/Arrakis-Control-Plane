...
This tracker converts the external security audit into implementation work for `dune-admin-fork`.
...
3. Stop persisting long-lived admin tokens in browser `localStorage`.
...
4. Add SBOM and artifact attestation workflow steps.
5. Remove committed binary artifacts or move them to signed release artifacts.
